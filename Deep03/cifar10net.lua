...
net = torch.load("gitTorch/Deep03/Run2/trained.net")
...
trainLogger = optim.Logger(paths.concat('/home/lakechen/gitTorch/Deep03', 'train.log'))
testLogger = optim.Logger(paths.concat('/home/lakechen/gitTorch/Deep03', 'test.log'))
...
for epoch = 1,optim_params.maxIteration do
   ...
   local filename = paths.concat('/home/lakechen/gitTorch/Deep03', 'trained.net')
