...
net = nn.Sequential()
	...
	V4 = nn.SpatialConvolution(6,12,5,5)
	V5 = nn.ReLU()
	V6 = nn.SpatialMaxPooling(2,2,2,2)
	V7 = nn.View(12*5*5)
	V8 = nn.Linear(12*5*5, 60)
	V9 = nn.ReLU()
	V10 = nn.Linear(60,10)
	V11 = nn.LogSoftMax()
net:add(V1)
...
--net = torch.load("gitTorch/Deep04/Run1/trained.net")
...
--[[Train the Network]]
optim_params = { learningRate = 0.001, momentum = 0.5, coefL1=0, coefL2=0.001, maxIteration=10000}
...
trainLogger = optim.Logger(paths.concat('/home/lakechen/gitTorch/Deep04', 'train.log'))
testLogger = optim.Logger(paths.concat('/home/lakechen/gitTorch/Deep04', 'test.log'))
...
for epoch = 1,optim_params.maxIteration do
   ...
   local filename = paths.concat('/home/lakechen/gitTorch/Deep04', 'trained.net')
